    ...
    <div class="top-bar">
        ...
        <div class="top-bar-brand">
            ...
            <a href="{{ route('admin.dashboard') }}">
                <img height="55" width="100%" viewbox="0 0 351 100" src="{{ asset('logo-white.png') }}" alt="">
            </a>
        </div>
        <!-- /.top-bar-brand -->
        <!-- .top-bar-list -->
            ...
            <div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
                ...
                <div class="dropdown d-none d-md-flex">
                    <button class="btn-account" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="user-avatar user-avatar-md"><img src="{{ asset( Auth::guard('admin')->user()->avatar ) }}" alt=""></span>
                        <span class="account-summary pr-lg-4 d-none d-lg-block">
                            <span class="account-name">{{ Auth::guard('admin')->user()->name }}</span>
                            <span class="account-description">{{ Auth::guard('admin')->user()->email }}</span>
                        </span>
