                ...
                <div class="card-body">
                    ...
                    <table id="table-users" class="table">
                        ...
                        <thead style="text-align: center;">
                            <tr>
                                <th style="min-width: 280px;"> Tên </th>
                                <th> Email </th>
                                <th> Username </th>
                                <th> Phone</th>
                                <th> Hành động </th>
...
@push('javascripts')
    <script>
        var song_datatable_route = "{{ route('admin.users.datatables.json') }}";
    </script>
    ...
    <script src="{{ asset('admin_assets/javascript/pages/users/datatables-users.js') }}"></script> <!-- END PAGE LEVEL JS -->
    <script src="{{ asset('admin_assets/javascript/pages/users/users.js') }}"></script>
@endpush