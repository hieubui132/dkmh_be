    ...
    <div class="page-inner">
        ...
        <header class="page-title-bar">
            <div class="d-flex flex-column flex-md-row">
                <p class="lead">
                    <span class="font-weight-bold">Hi, {{ Auth::guard('admin')->user()->name }}.</span> <span class="d-block text-muted">Here’s what’s happening with your business today.</span>
                </p>
            </div>
        </header>
        <!-- /.page-title-bar -->
                        ...
                        <div class="metric-row metric-flush">
                            ...
                            <div class="col">
                                ...
                                <a href="user-teams.html" class="metric metric-bordered align-items-center">
                                    <h2 class="metric-label"> Người dùng </h2>
                            ...
                            <div class="col">
                                ...
                                <a href="user-projects.html" class="metric metric-bordered align-items-center">
                                    <h2 class="metric-label"> Nhạc full </h2>
                                    <p class="metric-value h3">
                            ...
                            <div class="col">
                                ...
                                <a href="user-tasks.html" class="metric metric-bordered align-items-center">
                                    <h2 class="metric-label"> Nhạc demo </h2>
                                    <p class="metric-value h3">
                    ...
                    <div class="col-lg-3">
                        ...
                        <a href="user-tasks.html" class="metric metric-bordered">
                            <div class="metric-badge">
                                <span class="badge badge-lg badge-success"><span class="oi oi-media-record pulse mr-1"></span> Người đã mua</span>
                            </div>
                            <p class="metric-value h3">
